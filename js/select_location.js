let jsonList = [
    ...
    {
        "provice": "海南省",
        "city": ["海口市", "三亚市", "三沙市", "儋州市", "五指山市", "琼海市", "文昌市", "万宁市", "东方市", "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县", "陵水黎族自治县", "保亭黎族苗族自治县", "琼中黎族苗族自治县"]
    },
    {
        "provice": "重庆市",
    ...
    {
        "provice": "新疆维吾尔自治区",
        "city": ["乌鲁木齐市", "克拉玛依市", "吐鲁番市", "哈密市", "昌吉回族自治州", "博尔塔拉蒙古自治州", "巴音郭楞蒙古自治州", "阿克苏地区", "克孜勒苏柯尔克孜自治州", "喀什地区", "和田地区", "伊犁哈萨克自治州", "塔城地区", "阿勒泰地区", "石河子市", "阿拉尔市", "图木舒克市", "五家渠市", "铁门关市"]
    },
    {"provice": "香港", "city": ["香港"]},
    {"provice": "澳门", "city": ["澳门"]}];
...
function loadCityData() {
    for (let i = 0; i < jsonList.length; i++) {
        province = "<option data-index=" + i + " value='" + jsonList[i].provice + "'>" + jsonList[i].provice + "</option>";
        $(".provinceTarget").append(province);
...
$(function () {
    ...
    $(".provinceTarget").change(function (e) {
        let index = $(e.target).attr("id");
        index = index.charAt(index.length - 1);
        let cityTar = $("#city" + index);
        cityTar.empty();

        //alert(index);
        let opt = $("#province" + index + " option:selected").attr("data-index");
        if (opt === "-1") {
            city = "<option data-index='-1' value='城市'>城市</option>";
            cityTar.append(city);
        } else {
            let length = jsonList[opt].city.length;
